...
{ fetchNuGet }: [
  (fetchNuGet { pname = "Antlr4.Runtime.Standard"; version = "4.7.2"; hash = "sha256-BhWgy5MeAc43bANzOi1p1oPqRA3z4x/yt0A6iZ++ud4="; })
  ...
  (fetchNuGet { pname = "Microsoft.Z3.x64"; version = "4.8.7"; hash = "sha256-v1XK4bsYAvySTtScd9dsCC2exuTvaBEl36iX2pPgtPM="; })
