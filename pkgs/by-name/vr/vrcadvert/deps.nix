...
{ fetchNuGet }: [
  (fetchNuGet { pname = "MeaMod.DNS"; version = "1.0.70"; hash = "sha256-Hl6ZmKBbS6YZX7cc1Jp4/Hz6ksZqlFR7ZllbZgHzeYw="; })
  ...
  (fetchNuGet { pname = "VRChat.OSCQuery"; version = "0.0.7"; hash = "sha256-qivB0feWMAGYa6qE2pNK1Mhxt5xiFCICj9bEgUu2W+w="; })
]
