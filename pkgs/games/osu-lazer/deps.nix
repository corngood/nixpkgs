...
{ fetchNuGet }: [
  ...
  (fetchNuGet { pname = "ppy.osu.Framework"; version = "2024.625.0"; hash = "sha256-rfbGWoLE1qui/jvD2GToJwjyEOn3tfwatQAhjdIGC3s="; })
  ...
  (fetchNuGet { pname = "ppy.osu.Game.Resources"; version = "2024.622.0"; hash = "sha256-f2Ho8GC2gGXAfb5ULQOGhOHSnhb3BdlNbmt3ZDDeGSI="; })
