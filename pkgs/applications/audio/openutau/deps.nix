...
{ fetchNuGet }: [
  ...
  (fetchNuGet { pname = "Melanchall.DryWetMidi"; version = "6.1.4"; hash = "sha256-G1sMWcQcvfvPfgD9czfB+fhkw1fBCA511eqyI2w0FtQ="; })
  ...
  (fetchNuGet { pname = "NAudio.Midi"; version = "2.1.0"; hash = "sha256-cja5XOEII7nTxc5NyG9tAWe6RCXpL72Oo+HhgdiIk9I="; })
  (fetchNuGet { pname = "NAudio.Vorbis"; version = "1.5.0"; hash = "sha256-FX5EHVRLcWfjY+/NhkUf33fMFrTcPG3Ztm5ptmu1caw="; })
  (fetchNuGet { pname = "NetMQ"; version = "4.0.1.12"; hash = "sha256-O38SQuMRpTCz3YScEu0T9jw9DrVeQW5pAeHexYyooH8="; })
  ...
  (fetchNuGet { pname = "NLayer"; version = "1.14.0"; hash = "sha256-S2tLFI5vOmKG46IKgkaKR81MU+vCX0hhGJD+cdnyWZ8="; })
  (fetchNuGet { pname = "NLayer.NAudioSupport"; version = "1.3.0"; hash = "sha256-pFatpNO1MuspCsc4uIfJrqZohFg/H4XkEGZUbTKaX1g="; })
  ...
  (fetchNuGet { pname = "YamlDotNet"; version = "13.1.0"; hash = "sha256-X8XIors3stPADU6vWmqtZAkdXH0qViI+qxvlGip4D9c="; })
]
