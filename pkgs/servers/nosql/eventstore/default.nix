...
buildDotnetModule rec {
  ...
  postConfigure = ''
    ...
    mv "$NUGET_PACKAGES/gitinfo/2.0.26/build/GitInfo.targets"{,~}
    cp "$NUGET_PACKAGES/gitinfo/2.0.26/build/GitInfo.targets"{~,}
    substituteInPlace "$NUGET_PACKAGES/gitinfo/2.0.26/build/GitInfo.targets" \
